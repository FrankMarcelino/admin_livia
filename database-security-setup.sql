...
-- ============================================================================
-- STEP 2: CRIAR FUNÇÃO HELPER PARA OBTER TENANT_ID DO JWT
-- ============================================================================
...
CREATE POLICY "Users can manage tags from their tenant"
  ON tags
  FOR ALL
  USING (id_tenant = auth.get_tenant_id())
  WITH CHECK (id_tenant = auth.get_tenant_id());
...
--
-- 4. Como adicionar tenant_id ao JWT:
--    - No Supabase Dashboard → Authentication → URL Configuration
--    - Adicionar um hook de Auth para incluir tenant_id no token
--    - Ou usar metadata do usuário (user.app_metadata.tenant_id)
--
-- ============================================================================
